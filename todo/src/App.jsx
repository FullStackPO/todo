    ...
    <div className="bg-[#333] rounded-2xl p-5 w-1/3 h-[85vh]">
      ...
      className="flex flex-col gap-5">
        ...
        <p className="text-2xl text-white font-bold">Task Details</p>
          ...
          <textarea name="" id="" placeholder="Enter Details" rows={10} value={details} onChange={(e)=> setDetails(e.target.value)}
          className="outline-2 outline-white rounded-2xl p-4 text-white"></textarea>

          <button 
          className="bg-green-600 p-5 rounded-2xl active:scale-95">Add Task</button>
